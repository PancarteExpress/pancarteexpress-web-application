      ...
      <div key={service.id}>
        <div className={styles.orderResume}>
          ...
          <div style={{display: 'flex', gap: '10px'}}>
            ...
            <button type='button' onClick={() => setShowDetails(!showDetails)}>{showDetails ? 'Moins de details' : 'Plus de details' }</button>
          </div>
        </div>
        ...
        {showDetails && service.type === 'installation' && Object.entries(service.items)
        .filter(([key, item]) => {
